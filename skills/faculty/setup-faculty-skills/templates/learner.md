...
<!-- prior fields, languages, courses — what analogies can build on -->

## What works

<!-- teaching moves that land: pacing, terseness, analogy style, example domains -->

## What doesn't

<!-- moves that have failed, with a word on why -->

## Watch for

<!-- recurring wobbles, known gaps carried between courses -->
